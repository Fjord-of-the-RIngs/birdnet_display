...
cp "$SOURCE_DIR/avicommons.py" "$INSTALL_DIR/"
cp "$SOURCE_DIR/image_cache_utils.py" "$INSTALL_DIR/"
...
cp "$SOURCE_DIR/scripts/scan_bird_image_cache.py" "$INSTALL_DIR/scripts/"
cp "$SOURCE_DIR/scripts/cache_avicommons_images.py" "$INSTALL_DIR/scripts/"
cp "$SOURCE_DIR/scripts/build_display_image_cache.py" "$INSTALL_DIR/scripts/"
